    ...
    <div className="min-h-screen bg-bg-weak-50">
      <aside className="fixed inset-y-0 left-0 z-40 hidden w-60 flex-col border-r border-stroke-soft-200 bg-bg-white-0 lg:flex">
        <div className="flex h-16 items-center gap-2.5 px-5">
          <span className="grid size-8 place-items-center rounded-lg bg-primary-base text-sm font-semibold text-text-white-0">
            e
          </span>
        ...
        {user && (
          <div className="border-t border-stroke-soft-200 p-3">
            <div className="flex items-center gap-2.5 rounded-lg px-2 py-2">
              <span className="grid size-8 shrink-0 place-items-center rounded-full bg-primary-lighter text-xs font-semibold uppercase text-primary-base">
      ...
      <header className="sticky top-0 z-30 flex items-center gap-3 border-b border-stroke-soft-200 bg-bg-white-0 px-4 py-2.5 lg:hidden">
        <span className="grid size-7 shrink-0 place-items-center rounded-lg bg-primary-base text-xs font-semibold text-text-white-0">
          e
        </span>
